  ...
  <div class="mainContentContainer">
    ...
    <div class="filmBaseInfoContainer">
      ...
      <div class="filmBaseInfoMainContainer">
        ...
        <div class="filmBaseInfoContentContainer">
          ...
          <div class="filmTimeLength">
            {{ filmData.baseData.src}} / {{ filmData.baseData.dur}}分钟
          </div>
      ...
      <div class="filmBaseInfoCtrlContainer">
        <div class="wishBtn">
          <i class="fa fa-heart" aria-hidden="true"></i> 想看
        </div>
        <div class="scoreBtn ">
          <i class="fa fa-star" aria-hidden="true"></i> 评分
        </div>
      </div>
    </div>
...
<style scoped lang="scss">@function px2vw($px) {
